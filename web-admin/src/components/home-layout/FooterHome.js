...
import "../../styles/home-layout/footer.scss";
      ...
      <div>
        <div className="row">
          <div className="col-sm-4 footer__left">
            <p className="footer__title hideOnMobile1">MovieHub</p>
            <div className="row">
              ...
              <div className="col-sm-12">
                <div>
                  <a href="https://portal.vietcombank.com.vn/Pages/Home.aspx">
                    <img
                      className="footer__icon__up"
                      src={`/assets/imgFooter/VCB.png`}
                      alt="image1"
                    ></img>
                  </a>
                  <a href="https://www.agribank.com.vn/">
                    <img
                      className="footer__icon__up"
                      src={`/assets/imgFooter/AGRIBANK.png`}
                      alt="image2"
                    ></img>
                  </a>
                  <a href="https://www.vietinbank.vn/web/home/vn/index.html">
                    <img
                      className="footer__icon__up"
                      src={`/assets/imgFooter/VIETTINBANK.png`}
                      alt="image3"
                    ></img>
                  </a>
                  <a href="https://zalopay.vn/">
                    <img
                      className="footer__icon__up"
                      src={`/assets/imgFooter/zalopay_icon.png`}
                      alt="image5"
                    ></img>
                  </a>
                </div>
          ...
          <div className="col-sm-4 footer__right">
            <div className="hideOnMobile1">
              ...
              <a href="https://google.com.vn">
                <img
                  className="footer__icon__up"
                  src={`/assets/imgFooter/apple-logo.png`}
                  alt="logo"
                ></img>
              </a>
              <a href="https://google.com.vn">
                <img
                  className="footer__icon__up"
                  src={`/assets/imgFooter/android-logo.png`}
                  alt="logo2"
                ></img>
              </a>
            </div>
            <div className="nowrap">
              ...
              <a href="https://google.com.vn">
                <img
                  className="footer__icon__up"
                  src={`/assets/imgFooter/facebook-logo.png`}
                  alt="image6"
                ></img>
              </a>
              <a href="https://google.com.vn">
                <img
                  className="footer__icon__up"
                  src={`/assets/imgFooter/zalo-logo.png`}
                  alt="image7"
                ></img>
              </a>
            </div>
      ...
      <div>
        <div className="row">
          <div className="col-sm-3 footer__center">
            <a href="https://google.com.vn">
              <img
                className="footer__icon__left"
                src={`/assets/imgFooter/zion-logo.jpg`}
                alt="image8"
              ></img>
            </a>
          </div>
          <div className="col-sm-6 footer__center">
            <span className="footer__title">
              MOVIE BOOKING – SẢN PHẨM CỦA CÔNG TY CỔ PHẦN ZION
            </span>
            ...
            <div className="footer__address">
              ...
              <br />
              đăng ký thay đổi lần thứ 10, ngày 22 tháng 12 năm 2020 do Sở kế
