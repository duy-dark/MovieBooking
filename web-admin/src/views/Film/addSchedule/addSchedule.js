...
dispatch(createFilmSchedules(data))
  ...
  return (
    ...
    <Select  style={{ width: 250,marginLeft:10 }}onChange={handleChange} >
      {
    ...
    <Select className="room" onChange={getRoom} style={{ width: 120,marginLeft:10 }} options={optionRoom}   />
     </div>
     <div style={{display:"row"}}>
    <a style={{marginTop:5}}>TIMESTART</a>
    <TimePicker   style={{ width: 120,marginLeft:0 }}   onChange={(time,timeString)=>setStartTime(timeString)} />
    </div>
    <div style={{display:"row"}}>
