...
export function Theater(props) {   
    return (
        <div className={props.isActive ? "blog__theaters__theater active" : "blog__theaters__theater"} onClick={props.onClick}>
            <img src= {props.img} alt=""/>          
            <span className="theater__name">
                <span className="theater__name highlight">{props.info.highlight} </span>
                - {props.info.normal}
            </span>
...
class MainBlog extends React.Component {blog
    constructor(props){
        super(props);
        this.state = {           
            data: data,
    ...
    render() {
        ...
        const dateDefault = 0;
        const movies = theaters[currentTheater].dates[dateDefault].movies.slice();
        ...
        return (
            <div className="blog">
                <ul className="blog__theaters">
                    {showTheaters}
                </ul>
                <div className="blog__movies" style={{height: "705px"}}>                 
                    {showMovies}
                </div>
            </div> 
        );
