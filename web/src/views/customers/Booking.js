      ...
      <div className="booking-content">
        <div className="booking-content__header">
          ...
          <div className="booking-content__threater">
            <div className="booking-content__threater__name">
              {movies && movies.threater}
            </div>
        ...
        <div className="booking-content__list-seats">
          {listSeat.map((row, index) => (
            <RowSeatEl
              ...
              seats={seats}
              {...row}
              onSelectSeat={(seat) => selectSeat(seat)}
            />
          ))}
        </div>
      ...
      <div className="booking-form">
        ...
        <div className="booking-form__input booking-form__payment">
          ...
          <div className="group-radio">
            ...
            <div className="radio-form">
              ...
              />
              <label htmlFor="visa">
                <img src={`/assets/ic-visa.png`} alt="" />{" "}
                <span>Thanh Toán Visa, Jcb, master card</span>
              </label>
            </div>
          </div>
        </div>
        <button
          className={`booking-form-btn ${
            disabledBtn ? "booking-form-btn--disabled" : ""
          }`}
